///*-------------------日历控件--------------------------*/
//fieldset {margin:5px;padding:0 12px 12px 12px;border:1px solid #D4D4D4;	background-color:#F9F9F9;}
//#calendar{background: #F6F6F6;border: 2px solid #FF6600 ;width: 250px;}
//#calendar table tr{display: block;}
//#calendar_container{width: 250px;}
//caption{background: #F6F6F6;border: 2px solid #FF6600 ;width: 250px;}
//caption a {width: 25%;float: left;font-size: 14px;line-height: 28px;}
//caption select{float: left;}
//.over{background: #FF6600;}
//legend {background: #F6F6F6;font-weight:bold;}
...
function loadCalendar(){
	...
	j.setYears(beginY-10,beginY);
	j.bind('start_time',"bottom");
	j.bind('b');
}
//////////////JCalendar 类////////////////////////////
/***************************
